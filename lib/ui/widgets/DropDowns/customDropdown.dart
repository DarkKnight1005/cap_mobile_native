...
class CustomDropdownState<T> extends State<CustomDropdown<T>> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: CompositedTransformTarget(
        ...
        child: Container(
          // color: Colors.green,
          width: widget.hideButton ?  style.width : null,
          height: style.height,
          child: OutlinedButton(
            ...
            side: MaterialStateProperty.resolveWith<BorderSide>(
              (Set<MaterialState> states) {
                return style.shape != null ? style.shape!.side : BorderSide(color: Colors.white);
            }),
            ),
            
            onPressed: toggleDropdown,
            child: Padding(
              padding: EdgeInsets.symmetric(horizontal: (style.mainAxisAlignment != null && style.mainAxisAlignment == MainAxisAlignment.spaceBetween) ? 8 : 0),
              child: Row(
                mainAxisAlignment:
  ...
  OverlayEntry _createOverlayEntry() {
    ...
    var topOffset = offset.dy + size.height + 0;
              ...
              children: [
                Positioned(
                  ...
                  child: CompositedTransformFollower(
                    offset:
                      widget.dropdownStyle.offset != null ?  Offset(widget.dropdownStyle.offset!.dx, size.height + widget.dropdownStyle.offset!.dy) : Offset(0, size.height + 8),
                    link: this._layerLink,
